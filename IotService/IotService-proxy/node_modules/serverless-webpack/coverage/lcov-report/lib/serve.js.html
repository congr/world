...
<html lang="en">
<head>
    <title>Code coverage report for lib/serve.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> serve.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    app.use(bodyParser.json({
      limit: '5mb',
      type: (req) =&gt; <span class="cstat-no" title="statement not covered" >/json/.test(req.headers['content-type']),</span>
    }));
&nbsp;
    for (let funcConf of funcConfs) {
...
&nbsp;
        if (isLambdaProxyIntegration) {
          res.status(resp.statusCode || <span class="branch-1 cbranch-no" title="branch not covered" >200)</span>.send(resp.body);
        } else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jan 09 2017 16:24:14 GMT+0000 (GMT)
</div>
</div>
